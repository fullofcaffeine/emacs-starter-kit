...
(setq org-agenda-files (list "~/org/gtd/gtd.org" "~/org/gtd/calendar.org"))
...
(defun calendar ()
  (interactive)
  (find-file "~/org/gtd/calendar.org"))
...
(defun find-wiki () "Find files in the wiki dir" (interactive) (peepopen-goto-file-gui-manual "~/org/data/dynamic_reference"))
...
(global-set-key (kbd "C-x j") '(find-file "~/org/data/blog/journal.org"))
